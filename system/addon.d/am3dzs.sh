...
etc/presets/TransducerEQ_XML/Fugoo_Speaker/Fugoo_v1_TEQ_v1.xml
etc/presets/TransducerEQ_XML/JBL_Flip/M810_BT_TEQ_v2.xml
etc/presets/TransducerEQ_XML/JBL_Micro_Wireless/JBL_MICRO_WIRELESS_TEQ_v2.xml
